...
json1 = [
  {
    "GARMIN": [
      {
        "OBC_DILONG_COMMAND (ID: 0x1806E5F4)": [

          {
            "MaxAllowableChargingVoltageL": [
              [
                0.0,
              ],
              [
...
merged = merge_json_objects(json1 + json2)
